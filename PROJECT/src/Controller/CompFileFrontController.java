...
import Action.CompFile.CompDataBoardModifyView;
import Action.CompFile.CompDataBoardRealModifyAction;
    ...
    private void proccess(HttpServletRequest request, HttpServletResponse response){
		...
		if(command.equals("/CompDataBoardList.cf")){
		   ...
		   try{
		   	...
		   	action = new CompDataBoardModifyView();
		   try{
			   forward=action.execute(request, response);
		   }catch(Exception e){
			   e.printStackTrace();
		   	...
		   	action = new CompDataBoardRealModifyAction();
		   try{
			   forward=action.execute(request, response);
		   }catch(Exception e){
			   e.printStackTrace();
